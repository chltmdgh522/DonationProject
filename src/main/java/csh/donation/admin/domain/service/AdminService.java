package csh.donation.admin.domain.service;

import csh.donation.admin.domain.comment.JpaComment;
import csh.donation.admin.domain.member.JpaMember;
import csh.donation.admin.domain.repository.JpaCommentRepository;
import csh.donation.member.domain.member.Member;
import csh.donation.admin.domain.repository.JpaMemberRepository;
